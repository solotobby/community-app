 ...
 <main>
        <div class="hero-area f-header-space fix pt-232 pb-155  pt-md-100 pb-md-100 pt-xs-100 pb-md-100">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hero-text mb-50">
                            ...
                            <h2 class="animated-title">Raise Money</h2>
            ...
            {{-- <div class="hero-thumb-1">
                <img src="{{asset('assets__/img/famlic/home.jpg')}}" alt="thumb-1">
            </div> --}}
            <div class="hero-thumb-2 align-middle">
                <img src="{{asset('assets__/img/famlic/famlic_home.jpg')}}" alt="thumb-1">
            </div>
        </div>
