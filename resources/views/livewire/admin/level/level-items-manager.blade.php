<div class="content">
    <div class="mt-4 mx-4">
        ...
        <div>
            <p>Level Cap: <strong>#{{ number_format($level->entry_gift, 2) }}</strong> </p>
        </div>
                        ...
                        @foreach ($items as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-secondary" wire:click="toggleItemStatus({{ $item->id }})">
        ...
        <!-- Modal -->
        <div class="modal fade @if ($showModal) show d-block @endif" tabindex="-1" role="dialog" @if ($showModal)
        style="background-color: rgba(0,0,0,0.5);" @endif>
