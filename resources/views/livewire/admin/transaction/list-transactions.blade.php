<div class="content">
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-md-3">
            <div class="d-flex gap-2">
                <div>
                    ...
                    <input type="date" id="dateFrom" wire:model.live="dateFrom" class="form-control form-control-sm">
                </div>
                <div>
                    <label for="dateTo" class="form-label mb-0 small">To</label>
                    <input type="date" id="dateTo" wire:model.live="dateTo" class="form-control form-control-sm">
                </div>
            </div>
        </div>
        ...
        <div class="col-md-2">
            <button
                wire:click="$set('search', ''); $set('filterByType', ''); $set('filterByStatus', ''); $set('filterByReason', ''); $set('dateFrom', ''); $set('dateTo', '')"
