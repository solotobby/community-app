<div class="container py-4">
                ...
                @foreach ($availableItems as $item)
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card h-100 {{ $isSelected ? 'border-success' : '' }}">
                            <img src="{{ $item->item_url }}" class="card-img-top" style="height: 150px; object-fit: cover;">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>You selected {{ count($selectedItems) }} items. Items from your selection will be picked randomly as your rewards.</p>
                        <ul>
 ...
 @if ($showSuccess && $raffleDraw)
    ...
    <div class="celebration-ribbon-overlay position-fixed w-100 h-100" style="top: 0; left: 0; z-index: 9999; pointer-events: none;">
    ...
    <!-- Success Modal -->
    <div class="modal fade show" id="raffleSuccessModal" tabindex="-1" style="display: block; background-color: rgba(0,0,0,0.5);" aria-labelledby="raffleSuccessModalLabel" aria-hidden="false">
                    ...
                    <div class="winner-list bg-light rounded-3 p-4 mb-4">
                        ...
                        <div class="row g-2">
                            @foreach (json_decode($raffleDraw->reward, true) as $index => $reward)
                                <div class="col-md-6">
                                    <div class="card border-success border-2 h-100 winner-item" style="animation-delay: {{ $index * 0.2 }}s;">
                                        <div class="card-body text-center py-3">
                                            <div class="text-success mb-2">🎯</div>
                                            <h6 class="card-title mb-0 text-success fw-bold">{{ $reward['name'] }}</h6>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
    ...
    <style>
        ...
        .confetti:nth-child(3n) { background: #f9ca24; }
