                        ...
                        <tr>
                            ...
                            <td>
                                @if ($draw->status === 'pending' && now()->lt($draw->expired_at))
                                    <button wire:click="openClaimModal({{ $draw->id }})" class="btn btn-sm btn-success">
                                        Claim Now
                                    </button>
                                @elseif ($draw->status === 'earned')
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password"
                                    ...
                                    wire:model="new_transaction_pin"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password"
                                    ...
                                    wire:model="new_transaction_pin_confirmation"
                    ...
                    <form wire:submit.prevent="saveBankDetails">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('bank_name') is-invalid @enderror" wire:model="bank_name">
