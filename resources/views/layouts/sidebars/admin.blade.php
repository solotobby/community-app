<div class="content-side content-side-full">
    <ul class="nav-main">
        ...
        <!-- Level -->
        <li class="nav-main-item">
            <a class="nav-main-link nav-main-link-submenu {{ request()->routeIs('admin.*') ? 'active' : '' }}"
        ...
        <!-- Manage Users -->
        <li class="nav-main-item">
            <a class="nav-main-link nav-main-link-submenu {{ request()->routeIs('admin.users.*') ? 'active' : '' }}"
                data-toggle="submenu" href="#">
        ...
        <!-- Manage Games -->
        <li class="nav-main-item">
            <a class="nav-main-link nav-main-link-submenu {{ request()->routeIs('admin.transactions.*') ? 'active' : '' }}"
                data-toggle="submenu" href="#">
        ...
        <!-- Manage Questions -->
        {{-- <li class="nav-main-item">
            <a class="nav-main-link nav-main-link-submenu {{ request()->routeIs('admin.questions.*') ? 'active' : '' }}"
                data-toggle="submenu" href="#">
