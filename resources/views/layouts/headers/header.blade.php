                    ...
                    <div class="row g-0 text-center">
                        ...
                        <div class="col-2">
                            <a class="text-elegance" data-toggle="theme"
                                data-theme="{{asset('assets/css/themes/elegance.min.css')}}" href="javascript:void(0)">
                                <i class="fa fa-2x fa-circle"></i>
                            </a>
                        </div>
                        <div class="col-2">
                        ...
                        <div class="col-2">
                            <a class="text-corporate" data-toggle="theme"
                                data-theme="{{asset('assets/css/themes/corporate.min.css')}}" href="javascript:void(0)">
                                <i class="fa fa-2x fa-circle"></i>
                            </a>
                        </div>
                        <div class="col-2">
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0"
                ...
                <div class="px-2 py-3 bg-body-light rounded-top">
                    @php
                        $level = \App\Models\Level::find(Auth::user()->level);
                    @endphp
                ...
                <div class="p-2">
                    ...
                    <a class="dropdown-item d-flex align-items-center justify-content-between space-x-1"
                        href="{{ $settingsRoute }}" data-toggle="layout">
                        <span>Settings</span>
                ...
                <ul class="nav-items my-2 fs-sm">
                    ...
                    <li>
                        <a class="text-dark d-flex py-2" href="javascript:void(0)">
                            ...
                            <div class="flex-grow-1 pe-2">
                                <p class="fw-medium mb-1">Please check your payment info since we can’t validate them!
                                </p>
                    ...
                    <li>
                        <a class="text-dark d-flex py-2" href="javascript:void(0)">
                            ...
                            <div class="flex-grow-1 pe-2">
                                <p class="fw-medium mb-1">Please consider upgrading your plan. You are running out of
                                    space.</p>
